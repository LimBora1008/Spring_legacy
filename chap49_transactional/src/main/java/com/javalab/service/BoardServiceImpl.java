 ...
 * 	  즉, 모든 메소드를 실행하다가 (체크드)예외 발생시 자동 롤백된다
...
public class BoardServiceImpl implements BoardService {
	...
	/*
	 * [트랜잭션 메소드]
	 * 메소드에 붙은 @Transactional 어노테이션은 클래스에 붙은것보다 우선한다
	...
	public int insertBoard(BoardVo vo) {
		...
		/*
		 * vo에는 전달받은 값과 자동으로 채번된 번호까지 같이 저장되어 있다
		 * 정말 편리한 기능임.
		 * 마이바티스 저장시 시퀀스로 따진 번호를 여기에 넣어준다
		 ...
		 * 무결성 오류로 2차 저장한 데이터도 롤백되어버림. 트랜잭션 적용함
		 */
		log.info("2차 저장 전");
